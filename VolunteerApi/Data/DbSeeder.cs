...
namespace VolunteerApi.Data
{
    public class DbSeeder
    {
        ...
        private VolunteerContext db;
        private RoleManager<IdentityRole> RoleManager;
        private UserManager<ApplicationUser> UserManager;

        public DbSeeder(VolunteerContext dbContext, RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager)
        {
            db = dbContext;
        ...
        private async Task CreateUsersAsync()
        {
            ...
            {
                UserName = "Icantbelieveitsnotbutter",
                Email = "ICBINB@volunteer.com"
            };
